 ...
 * is good
 * 
 * optimal route is calculated with highways
 * 
 * @author hegde
 *
 */
public class AlgoWithHighway implements RoutingStrategy {
	...
	int[][] routeMatrix = { 	{ 0, 9, 6, 5, 3, 4, 6, 3, 7, 3, 5, 6, 5, 9, 6, 5, 3, 4, 6, 3, 7, 3, 5, 6, 9 }, 
								...
								{ 7, 2, 7, 4, 7, 1, 2, 6, 4, 6, 7, 8, 8, 0, 4, 4, 7, 1, 2, 6, 4, 6, 7, 8, 7 }, 
		...
		return routeMatrix[source][destination];
	}
